...
# // REPO    
REPO="https://dpvpn.berkahost.my.id/sc/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://dpvpn.berkahost.my.id/sc/Register"
...
wget -q https://dpvpn.berkahost.my.id/sc/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
